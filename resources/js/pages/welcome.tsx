            ...
            <div className="flex min-h-screen flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-83.75 text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href="/dashboard"
                                className="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-foreground/50"
                            >
                                Dashboard
                            </Link>
                        ) : (
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-83.75 flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg border border-border bg-card p-6 pb-12 text-[13px] leading-5 text-foreground shadow-sm lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-border">
                                    <span className="relative bg-card py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-xs">
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-foreground bg-foreground px-5 py-1.5 text-sm leading-normal text-background hover:bg-foreground/90"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-335/364 w-full shrink-0 overflow-hidden rounded-t-lg bg-destructive/10 lg:mb-0 lg:-ml-px lg:w-109.5 lg:rounded-t-none lg:rounded-r-lg">
                            {/* Laravel Logo */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-destructive opacity-100 transition-all duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            {/* 13 */}
                            <svg
                                className="relative mt-[-6.6rem] -ml-8 w-109.5 max-w-none [--stroke-color:var(--color-foreground)] lg:ml-0"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="text-foreground opacity-100 transition-all delay-300 duration-750 starting:opacity-0">
                                    <mask
                                        id="path-1-mask"
                                ...
                                <g className="text-destructive/40 opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-6.5">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-foreground/50 opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-12.75">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-destructive/30 opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-19.5">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-destructive/50 opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-25.5">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
                            ...
                            <div className="absolute inset-0 rounded-t-lg border border-border lg:rounded-t-none lg:rounded-r-lg"></div>
                        </div>
                    </main>
                </div>
