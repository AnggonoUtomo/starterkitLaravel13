                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-400">
                            Interactive Spatie RBAC Permission Matrix grouped by
                            DDD-Lite Submodules.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-indigo-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-600"
                    >
                            ...
                            <tr>
                                ...
                                {roles.map((role) => (
                                    ...
                                    >
                                        ...
                                        <div className="mt-0.5 font-mono text-[10px] font-normal text-indigo-400">
                            ...
                            {Object.entries(groupedPermissions).map(
                                ([submodule, perms]) => (
                                    <React.Fragment key={submodule}>
                                        ...
                                        <tr className="bg-slate-950/80 text-xs font-bold tracking-wider text-indigo-300 uppercase">
                                            <td
                                                colSpan={roles.length + 1}
                                                className="border-t border-slate-800 px-6 py-2.5"
                                            >
                                                📦 Submodule:{' '}
                                        ...
                                        {perms.map((permName) => (
                                            ...
                                            >
                                                <td className="flex items-center gap-2 px-6 py-3 font-mono text-xs text-slate-300">
