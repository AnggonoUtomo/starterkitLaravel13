            ...
            <div className="mx-auto max-w-7xl space-y-6 p-6">
                ...
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/20 transition hover:bg-emerald-600"
                    >
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900/60 p-4">
                    ...
                    >
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-slate-800 bg-slate-950 py-2 pr-4 pl-9 text-sm text-slate-200 placeholder-slate-500 focus:border-emerald-500 focus:outline-none"
                        />
                    </form>
                ...
                <div className="overflow-hidden rounded-xl border border-slate-800 bg-slate-900/60 shadow-xl">
                    <table className="w-full text-left text-sm text-slate-300">
                        <thead className="border-b border-slate-800 bg-slate-900 text-xs font-semibold tracking-wider text-slate-400 uppercase">
                            <tr>
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                ...
                                                user.roles.length > 0 ? (
                                                    user.roles.map((r) => (
                                                        <span
                                                            key={r}
                                                            className="inline-flex items-center gap-1 rounded border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 text-xs font-medium text-emerald-400"
                                                        >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className="rounded-lg bg-amber-500/10 p-1.5 text-amber-400 transition hover:bg-amber-500/20"
                                                ...
                                                <button
                                                    ...
                                                    className="rounded-lg bg-rose-500/10 p-1.5 text-rose-400 transition hover:bg-rose-500/20"
                                                    title="Delete User"
                                                >
