        ...
        <div className="mt-4 space-y-4 text-xs">
            ...
            <div className="flex justify-end gap-2 pt-2">
                <button
                    type="button"
                    onClick={onCancel}
                    className="px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground cursor-pointer font-medium"
                >
                    Batal
                </button>
                <button
                    ...
                    className={`rounded-lg px-4 py-2 text-xs font-semibold text-white transition disabled:opacity-50 cursor-pointer shadow-2xs ${
                        isEditMode ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-emerald-600 hover:bg-emerald-700'
                    }`}
                >
                    {isEditMode ? 'Perbarui Pengguna' : 'Simpan Pengguna'}
                </button>
            </div>
        </div>
    );
