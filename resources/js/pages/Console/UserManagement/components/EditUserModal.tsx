...
export default function EditUserModal({
    ...
    return (
        <TooltipProvider>
            <Dialog open={!!editingUser} onOpenChange={handleOpenChange}>
                <DialogContent className="flex max-h-[90vh] flex-col sm:max-w-2xl">
                    <DialogHeader className="shrink-0">
                        <div className="flex items-center gap-3">
                            <div className="flex size-10 items-center justify-center rounded-lg border border-indigo-500/20 bg-indigo-500/10 text-indigo-500">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="top">
                                            Perbarui nama lengkap pengguna
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full rounded-lg border border-border bg-background px-3 py-2 text-xs font-medium text-foreground transition outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
                                />
                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="top">
                                            Alamat email unik yang digunakan
                                            pengguna untuk masuk ke sistem.
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
                                <input
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                ...
                                <Tooltip>
                                    ...
                                    <TooltipContent side="top">
                                        Kosongkan kolom ini jika tidak ingin
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-1">
                                    ...
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="top">
                                            Pilih satu atau beberapa peran untuk
                                            menyesuaikan hak akses pengguna.
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
                                            ...
                                            <TooltipTrigger asChild>
                                                <button
                                                    ...
                                                    className={`flex items-center justify-between gap-2 rounded-lg border px-3.5 py-2.5 text-left text-xs font-medium transition enabled:cursor-pointer disabled:cursor-not-allowed ${
                                                        isSelected
                                                            ? 'border-indigo-500/50 bg-indigo-500/10 font-bold text-indigo-500 shadow-2xs'
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="rounded-full bg-indigo-500/15 px-2 py-0.5 font-mono text-[10px] font-semibold text-indigo-500">
                                                            {activeCount}/
                                                            {
                                                                group
                                                                    .permissions
                                                    ...
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <button
                                                                ...
                                                                className="flex items-center gap-1 text-[11px] font-semibold text-indigo-500 hover:underline enabled:cursor-pointer disabled:cursor-not-allowed"
                                                            >
                                                                {allGroupSelected ? (
                                                                    <>
                                                                            ...
                                                                            >
                                                                                <button
                                                                                    ...
                                                                                    className={`flex items-center justify-between gap-1.5 rounded-md border px-2.5 py-1.5 font-mono text-[11px] font-medium transition enabled:cursor-pointer disabled:cursor-not-allowed ${
                                                                                        isPermSelected
                                                                                            ? 'border-indigo-500/40 bg-indigo-500/15 font-semibold text-indigo-500'
                        ...
                        <DialogFooter className="shrink-0 border-t border-border pt-3">
                            <Tooltip>
                                ...
                                <TooltipContent side="top">
                                    Membatalkan perubahan data pengguna
                                </TooltipContent>
                            </Tooltip>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <button
                                        type="submit"
                                        disabled={isProcessing}
                                        className="rounded-lg bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-2xs transition hover:bg-indigo-700 enabled:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        {isProcessing
                                            ? 'Memproses...'
                                            : 'Simpan Perubahan'}
                                ...
                                <TooltipContent side="top">
                                    Simpan perubahan pengguna ke database
                                </TooltipContent>
                            </Tooltip>
                        </DialogFooter>
                    </form>
