# Dormitory & Permission Module Implementation Plan
...
|---|---|---|---|---|---|
| INC-001 | Database Migration & ULID Entity | - | Table pesantren_dormitory_permissions created | php artisan migrate | Completed |
